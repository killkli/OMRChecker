...
def _create_processing_tab(processor: OMRProcessorGradio) -> None:
    """
...
def _create_template_builder_tab(template_builder: TemplateBuilder) -> None:
    """
...
def _create_sheet_generator_tab(sheet_generator: OMRSheetGenerator) -> None:
    """
...
def _create_batch_generation_tab(batch_generator: BatchOMRGenerator) -> None:
    """
...
def create_gradio_interface():
    ...
    with gr.Blocks(
        ...
        with gr.Tabs():
            # Create all tabs
            _create_processing_tab(processor)
            _create_template_builder_tab(template_builder)
            _create_sheet_generator_tab(sheet_generator)
            _create_batch_generation_tab(batch_generator)
